...
public class GameOver implements Screen {
	...
	public GameOver(final Drop game) {
		this.game = game;
        // Aumentar o tamanho da fonte com escala
        this.game.font.getData().setScale(3.0f); // Dobrar o tamanho da fonte
        overSound = Gdx.audio.newSound(Gdx.files.internal("gameOver.mp3"));
        overSound.setVolume(3, .8f);
        overSound.play();
	}
    ...
    private void draw() {
        ...
        this.game.Fontbatch.begin();
            // Desenha o texto
            game.font.draw(game.Fontbatch, "Game Over!", 150, 200);
